...
(*This is not a type for all relataions! For a type U we can just show one realation on this type.*)
...
(*This is an upper bound for a chain in a partially ordered set! Not a general definition of upper bound.*)
